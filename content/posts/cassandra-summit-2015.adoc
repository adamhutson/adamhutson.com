...
and a “State of Cassandra” speech by Jonathan Ellis.  
...
A lot of the sessions that I tried to attend were so popular that they had to close when maximum room occupancy was reached.  
...
Some of the sessions I tried to attend were closed due to popularity, but I was able to make it into others.  
...
That way you are able to see  the sessions that you missed out on.  
